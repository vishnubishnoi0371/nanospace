            ...
            <div className='relative overflow-hidden min-h-[650px] xl:min-h-[800px] pb-20 bg-dark-black'>
                ...
                <div className="container custom-container">
                    <div className='flex relative flex-col justify-end lg:items-end z-50 md:mt-20'>
                        ...
                        <div className='p-5 md:p-8 lg:p-[50px_50px_34px_50px] rounded-[10px] backdrop-blur-[30px] lg:backdrop-blur-[10px] max-w-full max-sm:mt-[320px] max-lg:mt-[350px] lg:mt-20 max-md:mt-[350px] bg-white bg-opacity-[4%]'>

                            <div className='w-[234px] relative h-[73px]'>
                                <div className=' absolute'>
                                    <img className='w-[234px] h-[73px]' src={logo} alt="explore logo" />
                                    <span class="w-[156px] h-[56px] bg-off-white blur-[80px] md:block hidden absolute top-50 start-50 translate_middle z-0"></span>
                                </div>
                            </div>
                            ...
                            {EXPLORE_DATA_LIST.map((item, index) => (
                                <div className='flex gap-2.5 items-start mb-4' key={index}>
                                    <span class="block size-4 min-w-4 rounded-full bg-off-white mt-1.5 bg-opacity-20 after:absolute relative after:size-[11px] after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:bg-white after:rounded-full"></span>                                    <p className='text-base font-Saira max-w-[480px] font-normal text-off-white !leading-150'>{item.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
